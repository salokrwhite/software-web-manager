...
// GenerateOTPSecret returns a new random base32 TOTP secret.
...
// BuildOTPAuthURL builds the otpauth:// provisioning URL for an authenticator app.
...
// ValidateTOTP verifies a TOTP code against a secret within the allowed skew.
