...
// ResolveRegion derives a region from explicit client attributes, falling back to
// IP-based geo resolution when none were supplied.
func (h *Handler) ResolveRegion(attrs map[string]string, ip string) resolvedRegion {
